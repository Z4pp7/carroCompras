  ...
  <body>
      <nav class="navbar navbar-expand-lg ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="view/contacto.php">Contáctanos</a>
            </li>
            </ul>
            <form class="form-inline my- my-lg-0">
              <input class="form-control" type="search" placeholder="Buscar" >
              <button class="search-btn" type="submit"><i class="search-icon fas fa-search"></i></button>
            </form>
            <a class="nav-link" href="view/registro.php">Registrarse</a>
            <a class="nav-link-user" href="view/ingresar.php">Ingresar</a>
        </div>
      </nav>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active carousel-item-left">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect fill="#df5b54" width="100%" height="100%"></rect></svg>
        <div class="container">
...
<footer class="container">
    ...
    <p>© 2017-2018 Company, Inc. · <i class="fab fa-facebook-square"></i> · <i class="fab fa-instagram"></i></p>
  </footer>
