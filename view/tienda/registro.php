            ...
            <form method="post">
                ...
                <div class="datos">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" id="no"  minlength="3" placeholder="Nombres" name="nombres" onkeypress="return sololetra(event)" required/>
                                <small  class="form-text text-muted">Mínimo 3 caracteres.</small>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" id="ap"  minlength="3" placeholder="Apellidos" name="apellidos" onkeypress="return sololetra(event)" required/>
                                <small  class="form-text text-muted">Mínimo 3 caracteres.</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="datos">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="te" minlength="10" maxlength="10" placeholder="Teléfono" name="telefono" onkeypress="return numcar(event)" required/>
                        <small  class="form-text text-muted"></small>
                    </div>
                ...
                <div class="datos">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" id="pa"  minlength="3" placeholder="País" name="pais" onkeypress="return sololetra(event)" required/>
                                <small  class="form-text text-muted">Mínimo 3 caracteres.</small>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" id="po" minlength="3" placeholder="Provincia" name="provincia" onkeypress="return sololetra(event)" required/>
                                <small  class="form-text text-muted">Mínimo 3 caracteres.</small>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" id="ci" minlength="3" placeholder="Ciudad" name="ciudad" onkeypress="return sololetra(event)" required/>
                                <small  class="form-text text-muted">Mínimo 3 caracteres.</small>
                            </div>
                        </div>
                    </div>
