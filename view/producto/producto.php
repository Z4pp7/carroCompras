                   ...
                   >
                    <div class="card-body">
                      ...
                      <form action="" method="post">
                        ...
                        <input type="hidden" name="id_pr" id="id_pr" value="<?php echo openssl_encrypt($dato->getId_pr(),cod,key); ?>">
                        <input type="hidden" name="nombre_pr" id="nombre_pr" value="<?php echo openssl_encrypt($dato->getNombre_pr(),cod,key); ?>">
                        <input type="hidden" name="valor_pr" id="valor"value="<?php echo openssl_encrypt($dato->getValor_unitario_pr(),cod,key);?>">
                        <input type="hidden" name="cantidad_pr" id="codigo_pr" value="<?php echo openssl_encrypt(1,cod,key);?>">
